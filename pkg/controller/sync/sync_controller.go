...
import (
	...
	meditatev1beta1 "elmariofredo/meditate/pkg/apis/meditate/v1beta1"
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileSync{Client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &meditatev1beta1.Sync{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create
	// Uncomment watch a Deployment created by Sync - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &meditatev1beta1.Sync{},
	})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=meditate.vejlupek.cz,resources=syncs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=meditate.vejlupek.cz,resources=syncs/status,verbs=get;update;patch
func (r *ReconcileSync) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Sync instance
	instance := &meditatev1beta1.Sync{}
